...
$n{=}2$ each at 150M). On the \emph{graded} HopperStand barrier, by contrast, entropy $\times 3$ lifted one of
two seeds over the threshold (627 vs.\ 118; $\times 10$: 132/141 both walled) --- the knob can occasionally
shift a graded barrier but never dents the categorical wall.
SAC crosses 200 in 6/12 seeds by 5M and 5/5 by ${\sim}8$M (crossings 4.1--7.7M in 20M runs). TD-MPC2: 6/6 by
${\sim}1$M; 5M bests 295--481 ($n{=}4$, mean ${\sim}412$).
