...
The ablation's mildest cut is in fact a removability result: training consistency-OFF from scratch at the full
5M budget yields 165/475/481/511 ($n{=}4$) against the full model's $420 \pm 113$ ($n{=}12$) --- three seeds at
the top of the full band (reaching 440+ by ${\sim}2$M), one low seed below the full floor. On this task the
self-predictive loss is removable for typical seeds; its residual role is worst-seed insurance.
