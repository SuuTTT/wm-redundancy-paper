...
SAC crosses 200 in 5/8 seeds by 5M and 5/5 by ${\sim}8$M (crossings 4.1--7.7M). TD-MPC2: 6/6 by ${\sim}1$M;
5M bests 295--481 ($n{=}4$, mean ${\sim}412$).

\textbf{HopperStand --- graded.} PPO escapes 2/8 (budgets 120--285M per seed; both escapes peaked within 120M;
six walled ${\le}154$). SAC: 0/3 at 1M but 5/6 by 5M. TD-MPC2: 3/3 by ${\le}0.9$M (962/948/943; the third seed
by 0.3M). The matched-1M column is the cleanest statement: \emph{TD-MPC2 solves both hopper tasks at a budget
where neither model-free method solves either.}
