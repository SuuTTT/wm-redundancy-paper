...
official release (cheetah $\sim$919, hopper $\sim$581 for the reference implementation; ours is a non-anomalous baseline: hopper within the official seed spread, cheetah $-5\%$, walker $-17\%$, acrobot $-23\%$, with known causes (collection mode, physics backend) under active verification. All TD-MPC2 claims here are within-implementation relative comparisons). The strip
